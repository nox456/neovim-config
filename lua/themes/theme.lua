...
theme.set_highlights = function(c)
  ...
  hl(0, "EndOfBuffer", { fg = '#242b38', bg = 'NONE' })
  hl(0,"WinSeparator", { fg = c.grey_fg, bg = 'NONE'})
  ...
  hl(0, "CursorLine", { fg = 'NONE', bg = c.black })
  ...
  hl(0, "TelescopeResultsDiffChange", { fg = c.blue, bg = 'NONE' }) hl(0, "TelescopeResultsDiffDelete", { fg = c.red, bg = 'NONE' })
  ...
  hl(0, "NvimTreeEndOfBuffer", { fg = '#242b38', bg = 'NONE' })
  hl(0, "NvimTreeCursorLine", { fg = 'NONE', bg = c.black })
